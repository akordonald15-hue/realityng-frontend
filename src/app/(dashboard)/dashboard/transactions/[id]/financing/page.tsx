    ...
    <ProtectedRoute>
      <main className="mx-auto max-w-3xl p-4">
        ...
        <Card className="mt-6 p-4">
          <h2 className="text-lg font-semibold text-reality-text-primary">Finance this transaction</h2>
          ...
          <Link
            className="mt-4 inline-flex h-11 items-center justify-center rounded-md bg-brand-secondary px-4 text-sm font-semibold text-reality-text-primary"
