...
export default function SignUpPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-10">
      ...
      <p className="mt-2 text-muted">Start your RealityNG property journey with a secure account.</p>
      ...
      <p className="mt-6 text-sm text-muted">
        ...
        <Link className="font-semibold text-brand-700" href="/auth/sign-in">
          Sign in
        </Link>
      </p>
    </main>
