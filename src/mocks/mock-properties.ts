...
const propertySeeds: PropertySeed[] = [
  ...
  },
  {
    ...
    description:
      "Fully serviced three-bedroom apartment with elevator access, fitted kitchen, and strong rental appeal.",
    ...
    floor_area: "210",
    featured: true,
    amenities: ["Elevator", "Fitted kitchen", "Gym", "Pool", "Dedicated parking"],
    agentIndex: 0,
    imageOffset: 2,
    views_count: 990,
    inquiry_count: 35,
